...
| test/subject_test.txt   | 2947 rows, each indicating the subject associated with each measurement of test data.      |
| test/X_test.txt         | 2947 rows, each with 561 features associated with each measurement of test data.           |
| train/y_train.txt       | 7352 rows, each indicating the Activity ID associated with each measurement of train data. |
| train/subject_test.txt  | 7352 rows, each indicating the subject associated with each measurement of train data.     |
